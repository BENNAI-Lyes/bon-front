...
const Home = () => {
  ...
  const { dispatch, returnProducts } = useContext(ReturnProductsContext);

  //fetch products
  const { dispatch: dispatchProduct, products } = useContext(ProductsContext);
  useEffect(() => {
      ...
      <div className="wrapper">
        ...
        <div className="stat">
          <Chart
            data={expenseStatsM}
            dataKey="total"
            title="Dépenses totales par mois"
            grid={true}
          />
        </div>
      </div>
